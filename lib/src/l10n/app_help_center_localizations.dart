...
class AppHelpCenterLocalizations {
  ...
  static const _english = {
    ...
    'viewAllTrainingVideos': 'View all ({value})',
    'collapseTrainingVideos': 'Show less',
    'openTrainingVideoHint': 'Open video in browser',
    ...
    'feedbackContactHint': 'Contact info (optional; required for a reply)',
    'feedbackContactNote':
        'To receive a reply from the developer, please leave your email or another way to contact you.',
  ...
  static const _chinese = {
    ...
    'quickLinks': '快捷入口',
    'trainingVideos': '培训视频',
    'viewAllTrainingVideos': '查看全部（共 {value} 个）',
    'collapseTrainingVideos': '收起',
    'openTrainingVideoHint': '在浏览器中打开视频',
    'versionHistory': '版本历史',
    'faq': '常见问题',
    'feedback': '发送反馈',
    'rating': '给应用评分',
    ...
    'feedbackContactHint': '联系方式（选填，不填则作者无法回复）',
    'feedbackContactNote': '如需作者回复，请留下邮箱或其他可联系到你的方式。',
